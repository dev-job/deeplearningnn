package dl4j.learning.cnn.networks;
...
public class AnimalTest {
    ...
    protected static final Logger log = LoggerFactory.getLogger(AnimalTest.class);
    ...
    protected static int listenerFreq = 2;
    ...
    protected static int modelType = 2; // LeNet, AlexNet or Custom but you need to fill it out
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File("C:/Users/Schipstal/dl4j-examples/dl4j-examples/src/main/resources/animals/"); // TODO: dit is nog alleen geschikt voor windows
